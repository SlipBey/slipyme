...
export const TEAM_ICONS: Record<SocialKey, IconType> = {
  github: FiGithub,
  linkedin: FiLinkedin,
...
export const ROLE_STYLES: Record<
  RoleTag,
  { cap: string; bar: string; pill: string }
> = {
  software: {
    cap: "bg-gradient-to-r from-sky-700 via-sky-600 to-sky-500",
    bar: "bg-sky-500",
    pill: "bg-sky-500/10 text-sky-700 dark:text-sky-300 ring-sky-500/30",
  },
  design: {
    cap: "bg-gradient-to-r from-fuchsia-600 via-pink-600 to-rose-500",
    bar: "bg-pink-500",
    pill: "bg-pink-500/10 text-pink-700 dark:text-pink-300 ring-pink-500/30",
  },
  social: {
    cap: "bg-gradient-to-r from-emerald-600 via-green-600 to-teal-500",
    bar: "bg-emerald-500",
    pill: "bg-emerald-500/10 text-emerald-700 dark:text-emerald-300 ring-emerald-500/30",
  },
  other: {
    cap: "bg-gradient-to-r from-indigo-600 via-blue-600 to-cyan-500",
    bar: "bg-indigo-500",
    pill: "bg-indigo-500/10 text-indigo-700 dark:text-indigo-300 ring-indigo-500/30",
  },
};
...
export const MEMBERS: Member[] = [
  ...
  },
  {
    ...
    roleTag: "design",
    img: "/resimler/team/male.png",
    bio: "Designer of Slipyme Company & General Manager",
